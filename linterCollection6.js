...
// 📌 Fonction pour extraire l’URI sans `baseUrl`
...
// 📌 Génération de tests pour les champs JSON des réponses
...
// 📌 Variabilisation des en-têtes non générés automatiquement par Postman
...
// 📌 Traitement des requêtes et duplication en fonction des réponses
        ...
        if (item.item && Array.isArray(item.item)) {
            ...
            if (item.response && Array.isArray(item.response)) {
                item.response.forEach((responseExample) => {
                    ...
                    // 📌 Vérification de l'option concatNames avant de modifier le nom
...
// 📌 Modification de la collection Postman
